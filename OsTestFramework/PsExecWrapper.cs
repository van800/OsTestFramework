...
namespace JetBrains.OsTestFramework
{
  class PsExecWrapper
  {
    ...
    /// <returns></returns>
    public IElevatedCommandResult ExecuteElevatedCommandInGuest(string command, string[] args, TimeSpan startTimeout, TimeSpan? executionTimeout = null)
    {
      return ElevatedCommandInGuest("Execute", "", command, args, startTimeout, executionTimeout);
    }

    public IElevatedCommandResult DetachElevatedCommandInGuest(string command, string[] args, TimeSpan startTimeout, TimeSpan? executionTimeout = null)
    {
    ...
    {
      using (var processExecutor = new ProcessExecutor(_remoteEnvironment, commandType, psExecArg, command, args, startTimeout, executionTimeout))
      {
